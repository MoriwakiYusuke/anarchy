...
- [ ] T087 Run the full quickstart.md walkthrough (steps 1–9) on a fresh 3-node testnet and record any drift in [specs/019-direct-messages/quickstart.md](quickstart.md) — **DEFERRED**: testnet 環境必須。別セッションで実施。
